...
def promote_submission_candidate(
    *,
    ...
    class_allocation_config_path: str | Path | None = None,
    class_allocation_config: dict[str, Any] | None = None,
    ...
    metadata = {
        ...
        "class_allocation_config_path": _string_or_none(class_allocation_config_path),

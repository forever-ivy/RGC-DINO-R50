...
BASELINE_VAL_MAP=${BASELINE_VAL_MAP:-0.4133222840328082}
BASELINE_VAL_MAP50=${BASELINE_VAL_MAP50:-0.612555712480629}
LEADERBOARD_BASELINE=${LEADERBOARD_BASELINE:-48.335}
